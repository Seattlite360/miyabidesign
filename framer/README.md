...
**Properties:** Endpoint URL, Default type, Sample heading, Start heading (`{tier}` becomes the plan name), Logo (optional, a built-in copy is used if empty), Contact email, Contact phone.
